...
const InvitationSuccessScreen: React.FC = () => {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: `I just invited ${invitationCount} ${inviteType === 'contractor' ? 'contractors' : inviteType === 'client' ? 'clients' : 'friends'} to join FixRx! Join me in finding trusted home service professionals through friend recommendations. Use my code: MIKE2024`,
