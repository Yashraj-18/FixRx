...
const EmailAuthScreen: React.FC = () => {
  ...
  const { setUserEmail, setIsAuthenticated, setUserType, setUserProfile } = useAppContext();
  ...
  const handleSendLink = async () => {
    ...
    if (Date.now() - lastSendTime < 3000) {
      console.log('Magic link send blocked - too soon after last attempt');
      return;
    }
    ...
    try {
      ...
      console.log('🔄 Sending magic link...', { 
        ...
        timeSinceLastSend: Date.now() - lastSendTime 
      });
      
      // Clear any old session data before sending new magic link
