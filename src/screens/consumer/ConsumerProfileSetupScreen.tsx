...
const ConsumerProfileSetupScreen: React.FC = () => {
  ...
  const isFormValid = () => {
    return formData.firstName && formData.lastName && isPhoneValid();
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Ensure userType is set in context
      ...
      if (response.success && response.data) {
        ...
        // Backend failed, but continue with local state
        console.warn('Backend update failed, continuing with local state');
        setUserProfile({
          ...userProfile,
          ...formData,
          userType: 'consumer' as const,
